...
const connection = mongoose.connect('mongodb+srv://akshay4362:akshay@4362@cluster0-tra13.mongodb.net/trips?retryWrites=true&w=majority', { useNewUrlParser: true }, (err) => {
