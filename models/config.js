...
const connection = mongoose.connect('mongodb:mongodb+srv://akshay4362:akshay@4362@cluster0-tra13.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true }, (err) => {
